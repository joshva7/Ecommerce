            ...
            <div className=" flex flex-col md:flex-row mx-3">
                <form>
                    <div className=" flex flex-col md:mx-25 text-gray-600 font-medium md:w-1/2">
                        <span>Username*</span>
                        <input name='usernamefiled' type="text" onChange={(e) => setUsername(e.target.value)} placeholder="Username*" className=" outline-none px-5 py-2 my-2 border-2 border-gray-300 rounded-[5px]" required />
                        <span>Email*</span>
