    ...
    return (
        <div className='md:grid grid-cols-2 w-full items-center'>
            <div className="text-gray-500 mx-5 md:mx-25 mt-15 md:w-full">
                ...
                <input placeholder="Joshva@gmail.com*" onChange={(e) => setEmail(e.target.value)} type="text" className="w-full px-5 py-2 my-2 border-2 focus:border-[#425a8b] transition duration-500 outline-none border-gray-300 rounded-[5px] md:w-1/2  text-black" />
                <span className="font-medium block mt-2">Password</span>
                <input placeholder="*******************" type="text" onChange={(e) => setPassword(e.target.value)} className="w-full px-5 py-2 my-2 border-2 focus:border-[#425a8b]
